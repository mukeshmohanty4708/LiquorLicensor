...
router.post('/validate/question_query_zip_name', function(req,res){
    ...
    var sql_query = "select distinct ZIP from projectdb.locationinfo where li "+ where_str + " ORDER BY ZIP ASC"
    queryOpts = {
        text: sql_query,
        values: temp_val
    }
...
router.post('/validate/question_query_method_operation', function(req,res){
    ...
    var sql_query = "select distinct oi.METHOD_OF_OPERATION from projectdb.locationinfo li inner join projectdb.operationinfo oi on li.LICENSE_SERIAL_NUMBER = oi.LICENSE_SERIAL_NUMBER where " + where_str;
